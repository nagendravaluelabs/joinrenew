...
(function() {
    ...
    janrain.settings.appUrl                = EmberENV.JANRAIN.AIA_APP_URL;
    janrain.settings.capture.captureServer = EmberENV.JANRAIN.AIA_CAPTURE_SERVER;
    janrain.settings.capture.appId         = EmberENV.JANRAIN.AIA_APP_ID;
    janrain.settings.capture.clientId      = EmberENV.JANRAIN.AIA_API_CLIENT_ID;

    // These are the URLs for your Engage app's load.js file, which is necessary
    // to load the Capture Widget.
    var httpLoadUrl  = EmberENV.JANRAIN.AIA_HTTP_URL;
    var httpsLoadUrl = EmberENV.JANRAIN.AIA_HTTPS_URL;
    ...
    janrain.settings.capture.federateServer = EmberENV.JANRAIN.AIA_FEDERATE_SERVER;
    janrain.settings.capture.federateXdReceiver =  'http://aia-joinrenew-dev.s3-website-us-east-1.amazonaws.com/federateXdReceiver.html';
    janrain.settings.capture.federateLogoutUri = 'http://aia-joinrenew-dev.s3-website-us-east-1.amazonaws.com/blank.html';
